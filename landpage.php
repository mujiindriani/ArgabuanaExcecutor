...
<div class="container">
  ...
  <div class="card-body">
    <h5 class="card-title">Informasi Logistic</h5>
    <p class="card-text">Untuk mengetahui informasi logistic yang ada di pelabuhan silahkan tekan tombol di bawah.</p>
    <a href="logistic.php" class="btn btn-outline-secondary d-flex justify-content-center">Go</a>
  </div>
</div></div>
    <div class="col"><div class="card" style="width: 18rem; background-color: #DCDCDC; ">
  ...
  <div class="card-body">
    ...
    <a href="jadwal.php" class="btn btn-outline-secondary d-flex justify-content-center" >Go</a>
  </div>
</div></div>
    <div class="col"><div class="card" style="width: 18rem; background-color: #DCDCDC; ">
    ...
    <div class="row">
      ...
      <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
        ...
        <ul class="list-unstyled">
          <li>
            <a href="#!" class="text-white"><img src="images/22.png" style="width:30px; height:30px;" alt="">@arga_executor</a>
          </li>
          <li>
            <a href="#!" class="text-white"><img src="images/23.png" style="width:30px; height:30px;" alt="">@arex_00</a>
          </li>
          <li>
            <a href="#!" class="text-white"><img src="images/24.png" style="width:30px; height:30px;" alt="">Arex</a>
          </li>
          <li>
            <a href="#!" class="text-white"><img src="images/25.png" style="width:30px; height:30px;" alt="">arex@gmail.com</a>
          </li>
        </ul>
      </div>
      <!--Grid column-->
